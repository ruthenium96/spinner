...
TEST(order_of_summation, AAAA_S1_S2_S2xS2) {
    spinner::group::Group group_one(spinner::group::GroupTypeEnum::S2, {{1, 0, 3, 2}});
    spinner::group::Group group_two(spinner::group::GroupTypeEnum::S2, {{2, 3, 0, 1}});
...
TEST(order_of_summation, AAAAAAAAA_S1_S2_S2xS2) {
    spinner::group::Group group_one(spinner::group::GroupTypeEnum::S2, {{6, 7, 8, 3, 4, 5, 0, 1, 2}});
    spinner::group::Group group_two(spinner::group::GroupTypeEnum::S2, {{2, 1, 0, 5, 4, 3, 8, 7, 6}});
