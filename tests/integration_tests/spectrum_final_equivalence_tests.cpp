...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        OptimizationList(OptimizationList::LEX).Symmetrize(group_prism_tr).NonAbelianSimplify(),
        OptimizationList(OptimizationList::LEX).Symmetrize(group_prism_tr).Symmetrize(group_prism_di).NonAbelianSimplify(),
        ...
        OptimizationList(OptimizationList::LEX).TzSort().Symmetrize(group_prism_tr).NonAbelianSimplify(),
        OptimizationList(OptimizationList::LEX).TzSort().Symmetrize(group_prism_tr).Symmetrize(group_prism_di).NonAbelianSimplify(),
        ...
        OptimizationList(OptimizationList::LEX).TzSort().EliminatePositiveProjections().Symmetrize(group_prism_tr).NonAbelianSimplify(),
        OptimizationList(OptimizationList::LEX).TzSort().EliminatePositiveProjections().Symmetrize(group_prism_tr).Symmetrize(group_prism_di).NonAbelianSimplify(),
        OptimizationList(OptimizationList::LEX).TzSort().TSquaredSort().EliminateNonMininalProjections().SSquaredTransform(),
