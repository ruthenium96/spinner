...
void copySparseUnitaryMatrixToSparseUnitaryMatrix(
    std::unique_ptr<spinner::quantum::linear_algebra::AbstractSparseSemiunitaryMatrix>& matrix_to,
    const std::unique_ptr<spinner::quantum::linear_algebra::AbstractSparseSemiunitaryMatrix>& matrix_from,
    size_t shift) {
...
std::unique_ptr<spinner::quantum::linear_algebra::AbstractSparseSemiunitaryMatrix>
...
bool isEqualUpToVectorOrder(
    const std::unique_ptr<spinner::quantum::linear_algebra::AbstractSparseSemiunitaryMatrix>& lhs,
    const std::unique_ptr<spinner::quantum::linear_algebra::AbstractSparseSemiunitaryMatrix>& rhs) {
...
TEST(symmetrizer, 222222_Dih3_S2) {
    ...
    // Dih3 * S2, S2 * Dih3, their commutativity
    {
        ...
        spinner::space::Space space_first = spinner::space::optimization::OptimizedSpaceConstructor::construct(
            ...
            spinner::quantum::linear_algebra::FactoriesList());
