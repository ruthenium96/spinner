...
std::pair<Subspectrum, std::unique_ptr<quantum::linear_algebra::AbstractDenseMatrix>>
Subspectrum::energy(const Submatrix& hamiltonian_submatrix) {
    ...
    std::pair<Subspectrum, std::unique_ptr<quantum::linear_algebra::AbstractDenseMatrix>> answer = {
