...
class AllQuantitiesGetter {
    public:
      ...
      virtual OneOrMany<std::vector<std::reference_wrapper<const std::unique_ptr<linalg_structures::AbstractDenseVector>>>>
        getWeightsOfAllStates() const = 0;
      virtual OneOrMany<std::reference_wrapper<const std::unique_ptr<linalg_structures::AbstractDenseVector>>>
