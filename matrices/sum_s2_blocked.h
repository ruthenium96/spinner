...
//
//struct Only_J_S2 : Matrices {
//public:
//
//    const Block_Lex_Map_Symm& blm;
//
...
//    }
//
//    Add_To_Matrix hamiltonian_ = static_cast<Add_To_Matrix>(&Only_J_S2::add_to_hamiltonian);
//
//    Only_J_S2(const Block_Lex_Map_Symm &blm_,
...
//        degeneracy.reset();
//        for (int i = 0; i < blm.spin_boundaries.size(); ++i) {
//            double multiplicity = blm.spin_boundaries[i].total_mult;
...
//            for (int j = 0; j < blm.spin_boundaries[i].symm_boundaries.size() - 1; ++j) {
//                arma::dmat trans = blm.construct_transformation(i, j);
