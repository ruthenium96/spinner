...
int main() {
    ...
    Indexes ind_typ(mults);

    Indexes_P2 ind(mults, 0);
    ...
    std::cout << s_squared_new_basis_vector << std::endl;
...
//
//    // vertical:
//    js_arma(0, 7) = 10; js_arma(7, 0) = 10;
//    js_arma(1, 6) = 10; js_arma(6, 1) = 10;
//    js_arma(2, 5) = 10; js_arma(5, 2) = 10;
